...
| ----------------------------------------------------------------------------------- | -------------------- | -------------------------------------- |
| [7.3.0-dev.1](https://github.com/gravitational/teleport/releases/tag/v7.3.0-dev.1)  | September 17th, 2021 | Only for pre-production envioronments. |
| [7.3.0-dev.2](https://github.com/gravitational/teleport/releases/tag/v7.3.0-dev.2)  | October 1st, 2021    | Only for pre-production envioronments. |
| Release                                                                             | October 11th, 2021   | Production release.                    |
